...
from Creator.ObjectDetector import Detection
...
class Unit:
    ...
    def copy_imgs_from_ds(self, dataset: Dataset):
    ...
    def add_labels_from_ds(self, labels: []) -> None:
        """
    ...
    def append_item_to_json_file(self, label, path):
        """
